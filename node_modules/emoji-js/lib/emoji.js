...
;(function() {
	...
	var emoji = function(){
		 ...
		 */
		self.img_sets = {
			'apple' : {'path' : 'https://raw.githubusercontent.com/iamcal/emoji-data/340e3b897f71ca985ceccbd6b753e37776734f26/img-apple-64/', 'sheet' : '/emoji-data/sheet_apple_64.png', 'sheet_size' : 64, 'mask' : 1},
	...
	emoji.prototype.replacement = function(idx, actual, wrapper, variation, is_extra){
		...
		if (self.supports_css) {
			if (self.use_sheet && img.px != null && img.py != null){
				...
				return '<img class="emoji emoji-sizer" src="'+img.path+'" '+title+' data-codepoints="'+img.full_idx+'">';
